...
import React__default, { createContext, version, useContext, useRef, useCallback, useDebugValue, useEffect, memo, useState } from "react";
import { Box, Field, Stack, FieldLabel, FieldHint, FieldError } from "@strapi/design-system";
import { useIntl } from "react-intl";
import { useFetchClient, useNotification, auth, useLibrary, prefixFileUrlWithBackendUrl } from "@strapi/helper-plugin";
import "react-dom";
import { p as pluginId, R as RESOLVE_CONFIG } from "./index-7b09320f.mjs";
...
const ContextKey = Symbol.for(`react-redux-context-${version}`);
const gT = globalThis;
function getContext() {
...
const Editorjs = React__default.forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx(SStyleWrapper, { className: error !== "" ? "error" : null, children: config ? /* @__PURE__ */ jsx(
      Field,
      {
        id: name,
        name,
        ...
        children: /* @__PURE__ */ jsxs(Stack, { spacing: 1, children: [
          /* @__PURE__ */ jsx(FieldLabel, { children: formatMessage(intlLabel) }),
          /* @__PURE__ */ jsx(
            EditorjsFieldNew$1,
            {
              intlLabel,
...
//# sourceMappingURL=Editorjs-c2cd37cb.mjs.map
