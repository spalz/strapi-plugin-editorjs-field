          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("defs", { children: /* @__PURE__ */ jsxRuntime.jsxs(
              "radialGradient",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx("stop", { stopColor: "#1EE4FF" }),
                  /* @__PURE__ */ jsxRuntime.jsx("stop", { offset: "1", stopColor: "#1CADFF" })
                ]
              }
            ) })
          ]
...
const index = {
  register(app) {
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./Editorjs-641aac5d.js")).then((module2) => ({
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en-05212a08.js")), "./translations/ru.json": () => Promise.resolve().then(() => require("./ru-3eeede4c.js")) }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=index-9064377e.js.map
